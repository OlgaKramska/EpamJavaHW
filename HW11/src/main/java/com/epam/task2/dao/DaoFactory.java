...
public class DaoFactory {
    ...
    public static RepositoryDao<User, Integer> getUserDao() {
    ...
    public static RepositoryDao<Cookie, Integer> getCookieDao() {
        return new CookieDao(getConnection());
    }
    ...
    public static RepositoryDao<MetaData, Integer> getMetaDataDao() {
        return new MetaDataDao(getConnection());
    }
}
